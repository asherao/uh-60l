...
--[[
	...
	--Baileys UH60L Binds 2022JAN24
		...
		{down = device_commands.eng1FSS, cockpit_device_id = devices.ECQ, value_down = 1.0, name = _('Engine 1 FSS - XFD'), category = _('ECQ')},
    ...
    -- Others
        ...
        {down = Keys.showControlInd,				name = _('Show controls indicator - UH-60L') ,			 category = _('General')},
